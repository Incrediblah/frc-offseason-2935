...
// its always ofure's fault
    ...
    // SPEED PERCENTAGE
    public static double driveSpeedLimiter = 0.85;
  ...
  public static final class ShooterConstants{
    ...
    public static final double podiumTopVelocity = neoVortexRPM* 0; // was 1
    public static final double podiumBottomVelocity = neoVortexRPM * 0; //was 0.35
    ...
    public static final double ampTopVelocity = neoVortexRPM * 0 ; //was 0.025 
    public static final double ampBottomVelocity = neoVortexRPM * 0; //was 0.725

    public static final double flatTopVelocity = neoVortexRPM * .65; //was 75
    public static final double flatBottomVelocity = neoVortexRPM * .35; 
    ...
    public static final double shooterHoldInSpeed = neoVortexRPM * 0.1; 
     ...
     // SHOOTER MOTOR RAMP RATE 
     public static double shooterRampRate = 1;
  ...
  public static class StatusVariables{
    ...
    public static boolean alignedToCentre = false; 
    public static boolean alignActivated = false; 
  }
  ...
  public static class photonVisionConstants{
    ...
    // CAMERA NAME 
    public static String tagCameraName= "april_tag_camera";
    public static String intakeCameraName= "note_camera";

    public static String notePipeline = "note_pipeline"; 
    public static String tagPipeline = "april_tag_pipeline"; 
    ...
    public static double photonMaxDriveSpeed = 0.2; 
