...
public class RobotContainer {
  ...
  private void configureButtonBindings() {
    ...
    controllerSecondary.axisGreaterThan(OIConstants.leftTriggerAxis, OIConstants.triggerThreshold).toggleOnTrue(new shooterVelocityCommand(m_shooterSubsystem, ShooterConstants.flatTopVelocity, ShooterConstants.flatBottomVelocity));
